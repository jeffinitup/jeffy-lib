...
public class ContainerUtil {
    public static void handleSlotClick(int slotID, int clickType, int action,
        ...
        if (clickType == 1 && slotID >= 0 && slotID < player.openContainer.getInventory().size()) {
            ...
            if (slotAt instanceof SlotCrafting) {
                return;
            }
            ...
            player.openContainer.onCraftMatrixChanged(slotAt.inventory);
        }
    }
}
